...
onEvent('item.registry', event => {
	...
	while (true) {
		...
		simple("风化石灰岩", "Weathered Limestone", CR('weathered_limestone', 16), 3, S, 0x5E6055, 0x797E74)
		simple("白云岩", "Dolomite", CR('dolomite', 16), 3, S, 0xC2C2C2, 0xDADADA)
		simple("辉长岩", "Gabbro", CR('gabbro', 16), 3, S, 0x6B5D4F, 0x7D6B5A)
		simple("熔渣", "Scoria", CR('scoria', 16), 3, S, 0x2A130C, 0x553427)
		simple("深色熔渣", "Dark Scoria", CR('dark_scoria', 16), 3, S, 0x0D0706, 0x23201A)
		...
		simple("铜锭", "Copper Ingot", CR('copper_ingot', 8), 16, S, 0xDD7E5D, 0xFCEFBA)
		...
		simple("红树根", "Mangrove Root", BOP('mangrove_root', 4), 9, S, 0x795740, 0xB8AB88)
		...
		simple("工厂方块", "Factory Block", "16x chisel:factory/dots", 2, S, 0x211C10, 0x604B43)
		simple("实验室方块", "Laboratory Block", "16x chisel:laboratory/wallpanel", 4, S, 0x71706E, 0x9D9A98)
		...
		simple("石灰石（Architect's Palette模组）", "Architect's Limestone", AP('limestone', 32), 8, S, 0x756958, 0x7F7360)
